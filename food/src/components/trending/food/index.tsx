...
export  function CardHorizontalFood({ food }: {food: FoodProps}) {
 return (
   <Pressable className='flex flex-col rounded-xl relative'>
    ...
    <View className='flex flex-row bg-neutral-900 gap-1 rounded-full absolute top-2 right-3 px-2 py-1 items-center justify-center'>
    ...
    <Text className='text-gray-500 '>{food.time} - R${food.delivery}</Text>
   </Pressable>
  );
}